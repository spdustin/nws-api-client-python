...
class GlossarySDK(BaseSDK):
    ...
    def list_terms(
        ...
        *,
        ...
        accept_header_override: Optional[ListTermsAcceptEnum] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ListTermsResponse:
        ...
        if utils.match_response(http_res, "200", "application/ld+json"):
            return models.ListTermsResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.ListTermsResponseBody
                ),
