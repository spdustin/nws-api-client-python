...
class ListByStationAcceptEnum(str, Enum):
...
class Observations(BaseSDK):
    def list_by_station(
        ...
        *,
        ...
        accept_header_override: Optional[ListByStationAcceptEnum] = None,
    ...
    async def list_by_station_async(
        self,
        *,
        station_id: str,
        start: Optional[datetime] = None,
