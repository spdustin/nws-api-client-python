...
class GetProductsByTypeRequestTypedDict(TypedDict):
    type_id: str
    r"""."""


class GetProductsByTypeRequest(BaseModel):
    type_id: Annotated[
        str,
...
class GetProductsByTypeResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: components_textproductcollection.TextProductCollectionTypedDict


class GetProductsByTypeResponse(BaseModel):
    headers: Dict[str, List[str]]
