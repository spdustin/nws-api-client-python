...
class GetForecastRequestTypedDict(TypedDict):
...
GetForecastResponseResultTypedDict = TypeAliasType(
...
GetForecastResponseResult = TypeAliasType(
...
class GetForecastResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetForecastResponseResultTypedDict


class GetForecastResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetForecastResponseResult
