...
ListProductsResponseResultTypedDict = TypeAliasType(
    "ListProductsResponseResultTypedDict",
    Union[TextProductCollectionTypedDict, ProblemDetailTypedDict],
)


ListProductsResponseResult = TypeAliasType(
    "ListProductsResponseResult", Union[TextProductCollection, ProblemDetail]
)


class ListProductsResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ListProductsResponseResultTypedDict


class ListProductsResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ListProductsResponseResult
