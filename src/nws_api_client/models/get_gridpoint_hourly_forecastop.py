...
class GetGridpointHourlyForecastRequestTypedDict(TypedDict):
...
class GetGridpointHourlyForecastRequest(BaseModel):
    wfo: Annotated[
        NWSForecastOfficeID,
...
GetGridpointHourlyForecastResponseResultTypedDict = TypeAliasType(
...
GetGridpointHourlyForecastResponseResult = TypeAliasType(
    "GetGridpointHourlyForecastResponseResult",
    Union[GridpointForecastGeoJSON, ProblemDetail, GridpointForecastJSONLd, bytes],
)


class GetGridpointHourlyForecastResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetGridpointHourlyForecastResponseResultTypedDict


class GetGridpointHourlyForecastResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetGridpointHourlyForecastResponseResult
