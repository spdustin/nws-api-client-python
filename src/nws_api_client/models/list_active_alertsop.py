...
class ListActiveAlertsRequestTypedDict(TypedDict):
...
class ListActiveAlertsRequest(BaseModel):
    status: Annotated[
...
ListActiveAlertsResponseResultTypedDict = TypeAliasType(
...
ListActiveAlertsResponseResult = TypeAliasType(
    "ListActiveAlertsResponseResult",
    Union[AlertCollectionJSONLd, AlertCollectionGeoJSON, ProblemDetail, bytes],
)


class ListActiveAlertsResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ListActiveAlertsResponseResultTypedDict


class ListActiveAlertsResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ListActiveAlertsResponseResult
