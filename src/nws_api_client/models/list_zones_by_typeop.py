...
class ListZonesByTypeRequestTypedDict(TypedDict):
...
class ListZonesByTypeRequest(BaseModel):
...
ListZonesByTypeResponseResultTypedDict = TypeAliasType(
...
ListZonesByTypeResponseResult = TypeAliasType(
    "ListZonesByTypeResponseResult",
    Union[ZoneCollectionJSONLd, ZoneCollectionGeoJSON, ProblemDetail],
)


class ListZonesByTypeResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ListZonesByTypeResponseResultTypedDict


class ListZonesByTypeResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ListZonesByTypeResponseResult
