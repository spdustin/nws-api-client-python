...
class HazardsValue2TypedDict(TypedDict):
    ...
    significance: str
    r"""Significance code. This value will correspond to a P-VTEC significance code as defined in NWS Directive 10-1703. This will most frequently be \"A\" for a watch or \"Y\" for an advisory."""
