...
class ListActiveAlertsByAreaRequestTypedDict(TypedDict):
    area: Area
    r"""State or marine area code"""


class ListActiveAlertsByAreaRequest(BaseModel):
    area: Annotated[
...
ListActiveAlertsByAreaResponseResultTypedDict = TypeAliasType(
...
ListActiveAlertsByAreaResponseResult = TypeAliasType(
    "ListActiveAlertsByAreaResponseResult",
    Union[AlertCollectionJSONLd, AlertCollectionGeoJSON, ProblemDetail, bytes],
)


class ListActiveAlertsByAreaResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ListActiveAlertsByAreaResponseResultTypedDict


class ListActiveAlertsByAreaResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ListActiveAlertsByAreaResponseResult
