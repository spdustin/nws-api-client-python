...
class GetGridpointForecastRequestTypedDict(TypedDict):
...
class GetGridpointForecastRequest(BaseModel):
    wfo: Annotated[
        NWSForecastOfficeID,
...
GetGridpointForecastResponseResultTypedDict = TypeAliasType(
...
GetGridpointForecastResponseResult = TypeAliasType(
    "GetGridpointForecastResponseResult",
    Union[GridpointForecastGeoJSON, ProblemDetail, GridpointForecastJSONLd, bytes],
)


class GetGridpointForecastResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetGridpointForecastResponseResultTypedDict


class GetGridpointForecastResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetGridpointForecastResponseResult
