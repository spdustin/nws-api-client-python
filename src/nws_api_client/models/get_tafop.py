...
GetTafResponseResultTypedDict = TypeAliasType(
    "GetTafResponseResultTypedDict", Union[ProblemDetailTypedDict, bytes]
)


GetTafResponseResult = TypeAliasType(
    "GetTafResponseResult", Union[ProblemDetail, bytes]
)


class GetTafResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GetTafResponseResultTypedDict


class GetTafResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GetTafResponseResult
