...
class IconsAcceptEnum(str, Enum):
    APPLICATION_PROBLEM_PLUS_JSON = "application/problem+json"
    IMAGE_PNG = "image/png"


class IconsDualConditionAcceptEnum(str, Enum):
    APPLICATION_PROBLEM_PLUS_JSON = "application/problem+json"
    IMAGE_PNG = "image/png"


class IconsSummaryAcceptEnum(str, Enum):
    APPLICATION_LD_PLUS_JSON = "application/ld+json"
    APPLICATION_PROBLEM_PLUS_JSON = "application/problem+json"


class SatelliteThumbnailsAcceptEnum(str, Enum):
    APPLICATION_PROBLEM_PLUS_JSON = "application/problem+json"
...
class NwsClient(BaseSDK):
    ...
    def alerts_active_area(
        self,
        *,
        area: models.AlertsActiveAreaArea,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    def icons(
        ...
        *,
        ...
        time_of_day: str,
        first: str,
        size: Optional[Union[models.IconsSize, models.IconsSizeTypedDict]] = None,
        fontsize: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[IconsAcceptEnum] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.IconsResponse:
        r"""Returns a forecast icon. Icon services in API are deprecated.
        ...
        req = self._build_request(
            ...
            accept_header_value=accept_header_override.value
            if accept_header_override is not None
            else "application/problem+json;q=1, image/png;q=0",
            http_headers=http_headers,
            security=self.sdk_configuration.security,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "default", "application/problem+json"):
            ...
            return models.IconsResponse(
                result=utils.unmarshal_json(http_response_text, models.ProblemDetail),
                headers=utils.get_response_headers(http_res.headers),
            )
    ...
    def icons_dual_condition(
        ...
        *,
        ...
        second: str,
        size: Optional[
            Union[models.IconsDualConditionSize, models.IconsDualConditionSizeTypedDict]
        ] = None,
        fontsize: Optional[int] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[IconsDualConditionAcceptEnum] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.IconsDualConditionResponse:
        r"""Returns a forecast icon. Icon services in API are deprecated.
        ...
        request = models.IconsDualConditionRequest(
            set=set,
            time_of_day=time_of_day,
            first=first,
            second=second,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="iconsDualCondition",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "image/png"):
            return models.IconsDualConditionResponse(
                result=http_res, headers=utils.get_response_headers(http_res.headers)
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    async def icons_dual_condition_async(
        self,
        *,
        set: str,
        time_of_day: str,
    ...
    def icons_summary(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[IconsSummaryAcceptEnum] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.IconsSummaryResponse:
        r"""Returns a list of icon codes and textual descriptions. Icon services in API are deprecated.
        ...
        if utils.match_response(http_res, "200", "application/ld+json"):
            return models.IconsSummaryResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.IconsSummaryResponseBody
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, "4XX", "*"):
    ...
    def satellite_thumbnails(
        self,
        *,
        area: models.SatelliteThumbnailsArea,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        accept_header_override: Optional[SatelliteThumbnailsAcceptEnum] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SatelliteThumbnailsResponse:
        r"""Returns a thumbnail image for a satellite region. Image services in API are deprecated.
        ...
        request = models.SatelliteThumbnailsRequest(
            area=area,
        )
        ...
        req = self._build_request(
            ...
            accept_header_value=accept_header_override.value
            if accept_header_override is not None
            else "application/problem+json;q=1, image/jpeg;q=0",
            http_headers=http_headers,
            security=self.sdk_configuration.security,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="satellite_thumbnails",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "image/jpeg"):
            return models.SatelliteThumbnailsResponse(
                result=http_res, headers=utils.get_response_headers(http_res.headers)
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    async def satellite_thumbnails_async(
        self,
        *,
        area: models.SatelliteThumbnailsArea,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def point_stations(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PointStationsResponse]:
        r"""Returns a list of observation stations for a given point
        ...
        request = models.PointStationsRequest(
            point=point,
        )
        ...
        if utils.match_response(http_res, "301", "*"):
            return models.PointStationsResponse(result="", headers={})
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
        ...
        if utils.match_response(http_res, "default", "application/problem+json"):
            return models.PointStationsResponse(
                result=utils.unmarshal_json(http_res.text, models.ProblemDetail),
                headers=utils.get_response_headers(http_res.headers),
            )
    ...
    async def point_stations_async(
        self,
        *,
        point: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
