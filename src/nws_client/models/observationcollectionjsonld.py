...
class ObservationCollectionJSONLdTypedDict(TypedDict):
    at_context: NotRequired[JSONLdContextUnionTypedDict]
    at_graph: NotRequired[List[ObservationTypedDict]]
...
class ObservationCollectionJSONLd(BaseModel):
    ...
    at_graph: Annotated[Optional[List[Observation]], pydantic.Field(alias="@graph")] = (
        None
    )
