...
class AlertsActiveRequestTypedDict(TypedDict):
...
class AlertsActiveRequest(BaseModel):
    status: Annotated[
...
AlertsActiveResponseResultTypedDict = TypeAliasType(
...
AlertsActiveResponseResult = TypeAliasType(
    "AlertsActiveResponseResult",
    Union[AlertCollectionJSONLd, AlertCollectionGeoJSON, ProblemDetail, bytes],
)


class AlertsActiveResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: AlertsActiveResponseResultTypedDict


class AlertsActiveResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: AlertsActiveResponseResult
