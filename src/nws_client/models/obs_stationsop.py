...
class ObsStationsRequestTypedDict(TypedDict):
...
class ObsStationsRequest(BaseModel):
    id: Annotated[
        Optional[List[str]],
...
ObsStationsResponseResultTypedDict = TypeAliasType(
...
ObsStationsResponseResult = TypeAliasType(
...
class ObsStationsResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: ObsStationsResponseResultTypedDict


class ObsStationsResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: ObsStationsResponseResult
