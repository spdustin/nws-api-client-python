...
class GridpointForecastRequestTypedDict(TypedDict):
...
class GridpointForecastRequest(BaseModel):
    wfo: Annotated[
        NWSForecastOfficeID,
...
GridpointForecastResponseResultTypedDict = TypeAliasType(
...
GridpointForecastResponseResult = TypeAliasType(
    "GridpointForecastResponseResult",
    Union[GridpointForecastGeoJSON, ProblemDetail, GridpointForecastJSONLd, bytes],
)


class GridpointForecastResponseTypedDict(TypedDict):
    headers: Dict[str, List[str]]
    result: GridpointForecastResponseResultTypedDict


class GridpointForecastResponse(BaseModel):
    headers: Dict[str, List[str]]

    result: GridpointForecastResponseResult
